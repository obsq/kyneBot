...
from obsq import dispatcher, OWNER_ID, SUDO_USERS, WHITELIST_USERS, MESSAGE_DUMP, LOGGER
from obsq.modules.helper_funcs.handlers import CMD_STARTERS
from obsq.modules.helper_funcs.misc import is_module_loaded, send_to_list
...
# Time spended on reworking on the whole feds = 22+ hours by @obsquriel
# Time spended on updating version to v2 = 26+ hours by @obsquriel
#
